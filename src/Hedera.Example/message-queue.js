...
const { Client, TopicCreateTransaction,
    TopicMessageQuery, TopicMessageSubmitTransaction, Hbar,
    PrivateKey, AccountCreateTransaction } = require("@hashgraph/sdk");
...
async function createMessageQueue() {
    ...
    for (let i = 1; i <= 7; i++) {
        ...
        await sendMessage(newAccountId, newAccountPrivateKey, newTopicId, i);
       }
...
async function sendMessage(newAccountId, newAccountPrivateKey, newTopicId, i) {
